...
**An Agentic AI system I'm currently building.**

ERIS is my attempt to build an AI system that can reason, use tools,
remember context, interact with the world, and execute tasks.
